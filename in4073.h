...
#define MOTORDATA_CYCLES (1000/(TIMER_PERIOD*BLINKLED_HZ))
#define ENABLE_1HZ_PROFILING 0
#define HZ1 1
#define HZ1_CYCLES (1000/(TIMER_PERIOD*HZ1))
#define ENABLE_10HZ_PROFILING 0
#define HZ10 10
#define HZ10_CYCLES (1000/(TIMER_PERIOD*HZ10))
